            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block ">
                        <img src="<?php echo base_url('assets/img/slider (2).jpg') ?>" class="w-100 h-100" style="object-fit: cover;">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                                ...
                                <div class="form-group">
                                    <input type="username" class="form-control form-control-user" id="exampleInputEmail" placeholder="Masukan Username" name="username">
